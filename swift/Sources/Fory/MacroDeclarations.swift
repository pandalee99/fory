...
public struct ForyFieldType: Sendable {
  ...
  public static func int32(nullable: Bool = false, encoding: ForyFieldEncoding = .varint)
    -> ForyFieldType
  {
    _ = nullable
    _ = encoding
  ...
  public static func int64(nullable: Bool = false, encoding: ForyFieldEncoding = .varint)
    -> ForyFieldType
  {
    _ = nullable
    _ = encoding
  ...
  public static func int(nullable: Bool = false, encoding: ForyFieldEncoding = .varint)
    -> ForyFieldType
  {
    _ = nullable
    _ = encoding
  ...
  public static func uint32(nullable: Bool = false, encoding: ForyFieldEncoding = .varint)
    -> ForyFieldType
  {
    _ = nullable
    _ = encoding
  ...
  public static func uint64(nullable: Bool = false, encoding: ForyFieldEncoding = .varint)
    -> ForyFieldType
  {
    _ = nullable
    _ = encoding
  ...
  public static func uint(nullable: Bool = false, encoding: ForyFieldEncoding = .varint)
    -> ForyFieldType
  {
    _ = nullable
    _ = encoding
