...
public final class RecordComponent {
  ...
  private final Object typeUseMetadata;
  ...
  public RecordComponent(
    ...
    this.typeUseMetadata = typeUseMetadata;
  ...
  /**
   * Returns the type-use metadata object for this record component.
   *
   ...
   */
  public Object getTypeUseMetadata() {
    return typeUseMetadata;
  }
